...
export const metadata: Metadata = buildMetadata({
  title: "Adsentify — Find Winning Ads Before Your Competitors Do",
  description:
...
export default function HomePage() {
  ...
  const testimonials = [
    {
      quote: "Adsentify completely changed how we do creative strategy. We spotted a skincare ad going viral on Tuesday morning — by Friday we had our own version running. ROAS was 4.2x.",
      name: "Jordan Kim",
    ...
    {
      quote: "The velocity scoring is genuinely useful. Other tools just show you what's trending — Adsentify shows you what's ABOUT to trend. That 48-hour window is everything in paid social.",
      name: "Priya Mehta",
    ...
    {
      quote: "I cancelled my Minea and MagicBrief subscriptions the same week I signed up for Adsentify. The AI X-Ray alone is worth the price — it's like having a senior creative strategist on call.",
      name: "Marcus Webb",
      role: "Media Buyer",
      company: "Freelance",
      avatar: "MW",
  ...
  const schemas = [
    ...
    howToSchema({
      ...
      description:
        "Use Adsentify's velocity scoring, AI X-Ray analysis, and brief generator to discover and deploy winning ad creatives faster than the competition.",
      steps: [
        {
          name: "Discover",
          text: "Search 2M+ ads by velocity score, niche, platform, days running, or keyword. Adsentify's velocity engine scores every ad 0–100 every 30 minutes, surfacing what's gaining momentum right now — not just the ads with the most total views.",
          url: "https://adsentify.com/discover",
        },
        {
          name: "Deconstruct",
    ...
    faqSchema([
      {
        question: "How is Adsentify different from AdSpy, BigSpy, or Minea?",
        answer:
          "Most ad spy tools show you ads and leave you to guess why they work. Adsentify goes further: our AI X-Ray breaks down the hook structure, emotional triggers, script formula, and persuasion mechanics of every winning ad. Then the Brief Generator turns those insights into production-ready creative briefs in seconds. Adsentify also refreshes velocity data every 30 minutes vs. competitors' 24–48 hour lag.",
      },
      {
        question: "Where does the ad data come from?",
        answer:
          "Adsentify ingests ads from official platform data sources and public ad libraries (Meta Ad Library, TikTok Creative Center, YouTube) plus proprietary crawlers. Velocity scores are updated every 30 minutes based on real engagement metrics.",
      },
      {
        question: "What AI model powers the analysis?",
        answer:
          "The Ad Anatomy X-Ray and all creative brief outputs are powered by Claude (Anthropic). Adsentify uses Claude Opus for detailed anatomy breakdowns and Claude Sonnet for faster remix generation — quality where it matters, speed everywhere else.",
      },
      {
      ...
      {
        question: "What platforms does Adsentify track?",
        answer:
          "Adsentify fully supports TikTok, Meta (Facebook and Instagram), YouTube, and Google Ads. Velocity scores are calibrated per-platform so a TikTok score of 85 is comparable to a Meta score of 85 within their respective contexts.",
      },
    ]),
  ];
        ...
        <section className="relative overflow-hidden pt-28 pb-24 md:pt-36 md:pb-32">
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
            ...
            <p className="animate-reveal-up mx-auto mb-10 max-w-2xl text-lg text-muted-foreground leading-relaxed" style={{ animationDelay: "0.2s" }}>
              Adsentify tracks viral velocity across TikTok, Meta, YouTube, and more. Spot breakout creatives in the first 48 hours, deconstruct them with AI, and forge better ads — faster.
            </p>
        ...
        <section className="py-24 md:py-32 bg-surface/50">
          <div className="mx-auto max-w-3xl px-6">
            <div className="mb-12 text-center reveal">
              <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-accent">The Adsentify Difference</p>
            ...
            <div className="relative reveal overflow-hidden rounded-3xl border border-accent/30 bg-gradient-to-b from-accent/10 to-transparent p-16">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-10 text-lg text-muted">
                  Join 2,400+ marketers who use Adsentify to find it first.
                </p>
        ...
        <footer className="border-t border-border bg-surface py-12">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mt-8 border-t border-border/60 pt-6 text-center text-xs text-muted">
              © {new Date().getFullYear()} Adsentify. All rights reserved.
            </div>
          </div>
        </footer>
