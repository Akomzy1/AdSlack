...
export async function generateMetadata({
  ...
  return buildMetadata({
    title: `AdForge vs ${c.name}: Full Comparison (2026)`,
    description: `Honest comparison of AdForge vs ${c.name}. See feature differences, pricing, data freshness, and which ad spy tool is right for your team.`,
    path: `/vs/${c.slug}`,
    keywords: [
      `AdForge vs ${c.name}`,
      `${c.name} alternative`,
        ...
        <section className="border-b border-border/60 py-16">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-6 flex items-center gap-2 text-sm text-muted">
              <Link href="/" className="hover:text-foreground transition-colors">AdForge</Link>
              <span>/</span>
            ...
            <div className="inline-grid grid-cols-2 gap-4 rounded-2xl border border-border bg-surface p-5 sm:grid-cols-4">
              {[
                { label: "AdForge refresh", value: "30 min" },
                { label: `${competitor.name} refresh`, value: competitor.refreshRate },
                { label: "AdForge starts at", value: "$0/mo" },
        ...
        <div className="mx-auto max-w-5xl px-6 py-12 space-y-16">
                ...
                >
                  ...
                  <div className="border-l border-border/60 px-6 py-3.5 flex items-center justify-center">
                    {typeof row.adforge === "boolean" ? (
                      ...
                      <span className="text-sm font-medium text-accent">{row.adforge}</span>
                    )}
                  </div>
          ...
          <section className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-accent/30 bg-accent/5 p-6">
              <div className="mb-4 flex items-center gap-2">
                ...
                <h3 className="font-bold text-foreground">Why teams choose AdForge</h3>
              </div>
          ...
          <section className="rounded-2xl border border-border bg-surface p-8">
            ...
            <div className="mt-6">
              ...
              >
                Try AdForge free — no credit card →
              </Link>
            </div>
          </section>
